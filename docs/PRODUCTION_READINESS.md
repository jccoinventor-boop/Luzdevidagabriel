...
| Deploy Preview restringido | GO condicionado | Variables públicas separadas configuradas; falta validar el artefacto generado por Netlify. |
...
4. Falta validar la interfaz en el Deploy Preview de Netlify y completar el recorrido por Meta y Google Calendar.
